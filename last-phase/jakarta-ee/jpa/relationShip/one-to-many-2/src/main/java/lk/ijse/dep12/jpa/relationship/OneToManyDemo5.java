    ...
    public static void main(String[] args) {
        try (EntityManagerFactory emf = JpaUtil.getEntityManagerFactory();
            ...
            try {
                ...
                LawyerLawSuite lawyerLawSuite1 = new LawyerLawSuite(ls001, tharindu, new BigDecimal("65000.00"), Date.valueOf(LocalDate.now()));
                LawyerLawSuite lawyerLawSuite2 = new LawyerLawSuite(ls002, tharindu, new BigDecimal("75555.00"), Date.valueOf(LocalDate.now()));
