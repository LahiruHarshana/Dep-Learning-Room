...
class Customer {
    static doGet(req: IncomingMessage,res:ServerResponse){
        res.end("<h1>Customers: Get()</h1>")
    }
    static doPost(req: IncomingMessage,res:ServerResponse){
        res.end("<h1>Customers: Post()</h1>")
    }
    static doPut(req: IncomingMessage,res:ServerResponse){
