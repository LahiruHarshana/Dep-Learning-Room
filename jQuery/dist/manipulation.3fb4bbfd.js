...
(0, _jqueryDefault.default)("#btn-replace").on("click", ()=>{
    (0, _jqueryDefault.default)(".target-1").html("Random : " + Math.random() + "<button>Reset</button>");
});
(0, _jqueryDefault.default)("#btn-replace-with").on("click", ()=>{
    (0, _jqueryDefault.default)(".target-2").replaceWith("<Button>Reset</Button>");
});
(0, _jqueryDefault.default)("#btn-set-tooltip-text").on("click", ()=>{
    (0, _jqueryDefault.default)("h2").attr("tittle", "Hello Manipulation");
});
(0, _jqueryDefault.default)("#btn-get-tooltip-text").on("click", ()=>{
    alert((0, _jqueryDefault.default)("h2").attr("tittle"));
});
(0, _jqueryDefault.default)("#set-image-src").on("click", ()=>{
